...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="mb-8">
        <a href="{{ route('admin.suggestions.index') }}" class="text-primary hover:underline mb-2 inline-block">
            <i class="fas fa-arrow-left mr-1"></i>Back to Suggestions
        </a>
        <h1 class="text-4xl font-bold text-gray-800 dark:text-white mb-2">Suggestion Details</h1>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
        <div class="space-y-4">
            ...
            <div>
                ...
                <p class="mt-1 text-gray-700 dark:text-gray-300 whitespace-pre-line">{{ $suggestion->message }}</p>
            </div>
        ...
        <form method="POST" action="{{ route('admin.suggestions.status', $suggestion) }}" class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            @csrf
            @method('PUT')
            ...
            <button type="submit" class="mt-4 w-full bg-primary text-white px-6 py-3 rounded-lg hover:bg-blue-600 transition font-semibold">
